...
describe('Jira Server API Advanced Type Tests', () => {
  describe('Server/DC Specific Features', () => {
    ...
    it('should support common Server/DC custom field patterns', () => {
      ...
      expect((issueWithServerFields.customfield_10011 as any).value).toBe(
        'Backend Team'
      );
      expect(Array.isArray(issueWithServerFields.customfield_10012)).toBe(true);
      expect((issueWithServerFields.customfield_10016 as any).name).toBe(
        'tech.lead'
      );
      ...
      const serverIssue: Partial<JiraIssue> = {
        ...
        fields: {
          ...
          project: {
            ...
            avatarUrls: {
              '16x16':
                'https://jira-server.company.internal:8443/secure/projectavatar?size=xsmall&pid=10000',
              '24x24':
                'https://jira-server.company.internal:8443/secure/projectavatar?size=small&pid=10000',
              '32x32':
                'https://jira-server.company.internal:8443/secure/projectavatar?size=medium&pid=10000',
              '48x48':
                'https://jira-server.company.internal:8443/secure/projectavatar?size=large&pid=10000',
            },
          },
          issuetype: {
            ...
            description: 'A task',
            iconUrl:
              'https://jira-server.company.internal:8443/images/icons/issuetypes/task.png',
            subtask: false,
          },
          status: {
            ...
            iconUrl:
              'https://jira-server.company.internal:8443/images/icons/statuses/open.png',
            statusCategory: {
  ...
  describe('Edit Metadata and Field Schemas', () => {
    it('should handle complex edit metadata structure', () => {
      const editMeta: JiraEditMeta = {
        fields: {
          ...
          assignee: {
            ...
            operations: ['set'],
            autoCompleteUrl:
              'http://example.com/jira/rest/api/2/user/assignable/search?project=PROJ',
          ...
          customfield_10008: {
            ...
            operations: ['set'],
            autoCompleteUrl:
              'http://example.com/jira/rest/api/2/epic/none/issue/picker',
          },
          priority: {
            required: false,
            schema: {
            ...
            allowedValues: [
              {
                ...
                iconUrl:
                  'http://example.com/jira/images/icons/priorities/blocker.png',
                name: 'Blocker',
                id: '1',
              },
              {
                ...
                iconUrl:
                  'http://example.com/jira/images/icons/priorities/critical.png',
                name: 'Critical',
                id: '2',
              },
            ],
            defaultValue: {
              ...
              iconUrl:
                'http://example.com/jira/images/icons/priorities/major.png',
              name: 'Major',
              id: '3',
            },
          },
      ...
      expect(editMeta.fields.assignee?.autoCompleteUrl).toContain(
        'assignable/search'
      );
  ...
  describe('Complex Search Scenarios', () => {
    it('should handle search with all expansions and fields', () => {
      const complexSearchResult: JiraSearchResponse = {
        expand:
          'names,schema,operations,editmeta,changelog,versionedRepresentations,renderedFields',
        startAt: 0,
        maxResults: 2,
        total: 150,
        issues: [
          {
            ...
            fields: {
              ...
              issuetype: {
                ...
                iconUrl:
                  'http://example.com/jira/images/icons/issuetypes/story.png',
                name: 'Story',
                subtask: false,
                avatarId: 10315,
                hierarchyLevel: 0,
              ...
              project: {
                ...
                avatarUrls: {
                  '16x16':
                    'http://example.com/jira/secure/projectavatar?size=xsmall&pid=10000',
                  '24x24':
                    'http://example.com/jira/secure/projectavatar?size=small&pid=10000',
                  '32x32':
                    'http://example.com/jira/secure/projectavatar?size=medium&pid=10000',
                  '48x48':
                    'http://example.com/jira/secure/projectavatar?size=large&pid=10000',
                },
                projectCategory: {
              ...
              status: {
                ...
                iconUrl:
                  'http://example.com/jira/images/icons/statuses/generic.png',
                name: 'Backlog',
                id: '10001',
                statusCategory: {
              ...
              parent: {
                ...
                fields: {
                  ...
                  status: {
                    ...
                    iconUrl:
                      'http://example.com/jira/images/icons/statuses/inprogress.png',
                    name: 'In Progress',
                    id: '3',
                    statusCategory: {
                  ...
                  priority: {
                    self: 'http://example.com/jira/rest/api/2/priority/2',
                    iconUrl:
                      'http://example.com/jira/images/icons/priorities/high.svg',
                    name: 'High',
                    id: '2',
                    statusColor: '#ff5722',
                  ...
                  issuetype: {
                    ...
                    iconUrl:
                      'http://example.com/jira/images/icons/issuetypes/epic.png',
                    name: 'Epic',
                    subtask: false,
                  },
                },
            ...
            renderedFields: {
              description:
                '<p>This issue demonstrates all possible field types</p>',
      ...
      expect(
        complexSearchResult.issues[0]?.renderedFields?.description
      ).toContain('<p>');
      expect(complexSearchResult.issues[0]?.operations?.linkIssue?.label).toBe(
        'Link'
      );
      expect(complexSearchResult.warningMessages?.[0]).toContain(
        'execution took longer'
      );
      expect(complexSearchResult.schema?.customfield_10008?.customId).toBe(
        10008
      );
    });
  });

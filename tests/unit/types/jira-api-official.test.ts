...
describe('Jira Server API Official Documentation Compliance', () => {
  ...
  describe('Issue Entity (/rest/api/2/issue)', () => {
    it('should match official issue response structure', () => {
      ...
      const officialIssueResponse: JiraIssue = {
        ...
        fields: {
          ...
          project: {
            ...
            versions: [],
            roles: {
              "Administrators": "http://www.example.com/jira/rest/api/2/project/EX/role/10002"
            }
          },
          status: {
          ...
          priority: {
            ...
            iconUrl: "http://www.example.com/jira/images/icons/priorities/medium.svg",
            name: "Medium",
            id: "3",
            statusColor: "#ffab00",
          ...
          reporter: {
            ...
            avatarUrls: {
              "48x48": "http://www.example.com/jira/secure/useravatar?size=large&ownerId=admin",
              "24x24": "http://www.example.com/jira/secure/useravatar?size=small&ownerId=admin",
              "16x16": "http://www.example.com/jira/secure/useravatar?size=xsmall&ownerId=admin",
              "32x32": "http://www.example.com/jira/secure/useravatar?size=medium&ownerId=admin"
            },
            active: true,
            id: "10001"
          },
          ...
          fixVersions: [
            {
              ...
              project: "EX",
              projectId: 10000,
              moveUnfixedIssuesTo: "http://www.example.com/jira/rest/api/2/version/10001",
              operations: [],
              remotelinks: []
            }
          ],
          ...
          subtasks: [
            {
              ...
              fields: {
                ...
                status: {
                  ...
                  iconUrl: "http://www.example.com/jira/images/icons/statuses/inprogress.png",
                  name: "In Progress",
                  id: "3",
                  statusCategory: {
                ...
                priority: {
                  ...
                  iconUrl: "http://www.example.com/jira/images/icons/priorities/high.svg",
                  name: "High",
                  id: "2",
                  statusColor: "#ff5722",
                ...
                issuetype: {
                  ...
                  iconUrl: "http://www.example.com/jira/images/icons/issuetypes/subtask.png",
                  name: "Sub-task",
                  subtask: true
                }
              }
              ...
              outwardIssue: {
                ...
                fields: {
                  ...
                  priority: {
                    ...
                    iconUrl: "http://www.example.com/jira/images/icons/priorities/low.svg",
                    name: "Low",
                    id: "4",
                    statusColor: "#2e7d32",
      ...
      expect(officialIssueResponse.fields.status.statusCategory.key).toBe("new");
      expect(officialIssueResponse.fields.components[0]?.lead?.name).toBe("fred");
      expect(officialIssueResponse.fields.subtasks?.[0]?.fields.issuetype.subtask).toBe(true);
    });
        ...
        attachment: [
          {
            ...
            size: 2048,
            mimeType: "text/plain",
            content: "http://www.example.com/jira/secure/attachment/10000/error-log.txt",
  ...
  describe('User Entity (/rest/api/2/user)', () => {
    it('should match official user response structure', () => {
      ...
      expect(officialUserResponse.groups?.items[0]?.name).toBe("jira-administrators");
    });
  });
  ...
  describe('Project Entity (/rest/api/2/project)', () => {
    it('should match official project response structure', () => {
      ...
      const officialProjectResponse: JiraProject = {
        ...
        issueTypes: [
          ...
          },
          {
            ...
            iconUrl: "http://www.example.com/jira/images/icons/issuetypes/subtask_alternate.png",
            name: "Sub-task",
            subtask: true,
            avatarId: 10316,
            hierarchyLevel: -1
        ...
        roles: {
          "Administrators": "http://www.example.com/jira/rest/api/2/project/EX/role/10002",
          "Developers": "http://www.example.com/jira/rest/api/2/project/EX/role/10001"
        },
        avatarUrls: {
          "48x48": "http://www.example.com/jira/secure/projectavatar?size=large&pid=10000",
          "24x24": "http://www.example.com/jira/secure/projectavatar?size=small&pid=10000",
      ...
      expect(officialProjectResponse.components[0]?.assigneeType).toBe("PROJECT_LEAD");
      expect(officialProjectResponse.issueTypes.length).toBe(2);
      expect(officialProjectResponse.roles["Administrators"]).toContain("/role/10002");
    ...
    it('should match official board response structure', () => {
      ...
      const officialBoardResponse: JiraBoard = {
        ...
        location: {
          ...
          projectKey: "PROJ",
          projectTypeKey: "software",
          avatarURI: "http://www.example.com/jira/secure/projectavatar?size=medium&pid=10000",
          name: "Project name"
        },
        canEdit: true,
        isPrivate: false,
  ...
  describe('Transitions (/rest/api/2/issue/{issueIdOrKey}/transitions)', () => {
    it('should match official transitions response structure', () => {
      ...
      expect(officialTransitionResponse.fields?.resolution?.required).toBe(true);
    });
  });
});
...
export const EnvironmentSchema = z.enum(['development', 'test', 'production'] as const);

// Log level enum schema
export const LogLevelSchema = z.enum(['error', 'warn', 'info', 'debug', 'trace'] as const);

// Log format enum schema
export const LogFormatSchema = z.enum(['simple', 'json', 'structured'] as const);
...
export const JiraServerConfigSchema = z.object({
  ...
  message: 'Authentication token mismatch between auth.personalToken and personalToken',
